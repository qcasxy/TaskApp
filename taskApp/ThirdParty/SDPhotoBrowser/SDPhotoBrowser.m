...
- (void)setupToolbars
{
    ...
    indexLabel.frame = CGRectMake(0, kScreenHeight - kSafeAreaBottomHeight - 30, 80, 30);
...
//        [LBXScanNative recognizeImage:currentImageView.image success:^(NSArray<LBXScanResult *> *array) {
...
//        erView = [[ErWeiMaView alloc]init];
//        erView.backgroundColor = [UIColor colorWithRed:208/255 green:208/255 blue:208/255 alpha:0.5];
//        [erView.quBtn addTarget:self action:@selector(quXiaoBtn) forControlEvents:UIControlEventTouchUpInside];
//        [erView.baoBtn addTarget:self action:@selector(saveImage) forControlEvents:UIControlEventTouchUpInside];
//        [self addSubview:erView];
//        erView.frame=CGRectMake(0, 0,self.frame.size.width, self.frame.size.height);
//        return;
//    }
//    
...
//
//    }else{
//        sdView = [[SDView alloc]init];
//        sdView.backgroundColor = [UIColor colorWithRed:208/255 green:208/255 blue:208/255 alpha:0.5];
//        [sdView.quBtn addTarget:self action:@selector(quXiaoSdViewBtn) forControlEvents:UIControlEventTouchUpInside];
//        [sdView.baoBtn addTarget:self action:@selector(saveImage) forControlEvents:UIControlEventTouchUpInside];
//        [sdView.shiBtn addTarget:self action:@selector(shiBieBtn) forControlEvents:UIControlEventTouchUpInside];
//        [self addSubview:sdView];
//        resultStr =strResult.strScanned;
//        sdView.frame=CGRectMake(0, 0,self.frame.size.width, self.frame.size.height);
//    }
//    NSLog(@"111%@",strResult.strScanned);
//
//}
//-(void)shiBieBtn{
//    if ([self isUrlAddress:resultStr]==YES) {
//        if (@available(iOS 10.0, *)) {
//            [[UIApplication sharedApplication] openURL:[NSURL URLWithString:resultStr] options:@{} completionHandler:^(BOOL success) {
//
//            }];
//        } else {
...
//    }else{
//        [self hideAllToasts];
//        [self makeToast:[NSString stringWithFormat:@"不是链接:内容为%@",resultStr] duration:2 position:CSToastPositionCenter];
//    }
//
//
//}
...
- (void)saveImage
{
    ...
    NSLog(@"%@",currentImageView.image); UIImageWriteToSavedPhotosAlbum(currentImageView.image, self, @selector(image:didFinishSavingWithError:contextInfo:), NULL);
...
- (void)layoutSubviews
{
    ...
    _indexLabel.center = CGPointMake(self.bounds.size.width * 0.5, kScreenHeight - kSafeAreaBottomHeight - 30);
