...
@interface CompletedVC ()<UITableViewDelegate,UITableViewDataSource>
...
-(void)load_taskRecord:(BOOL)isYes{
    [HttpTool get:API_POST_taskRecord dic:@{@"type":@"5",@"pagesize":@"15",@"page":[NSString stringWithFormat:@"%d",self.page]} success:^(id  _Nonnull responce) {
